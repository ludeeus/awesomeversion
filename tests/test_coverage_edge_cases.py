...
def test_buildver_section_valueerror():
    ...
    with patch.object(type(av), 'string', new_callable=lambda: property(lambda self: "not_a_number")):
        result = av.section(0)
